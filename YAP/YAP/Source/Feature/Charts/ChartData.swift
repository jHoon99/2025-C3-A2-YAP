...
struct ChartData {
  ...
  static let bodyCompositionData: [Series] = [
    .init(name: "체중 (kg)", measurements: [
      (day: Date.of(year: 2022, month: 5, day: 2), amount: 80.2),
      (day: Date.of(year: 2022, month: 5, day: 9), amount: 80.0),
      (day: Date.of(year: 2022, month: 5, day: 16), amount: 79.8),
      (day: Date.of(year: 2022, month: 5, day: 23), amount: 79.2),
      (day: Date.of(year: 2022, month: 5, day: 30), amount: 78.8),
      (day: Date.of(year: 2022, month: 6, day: 7), amount: 78.6),
      (day: Date.of(year: 2022, month: 6, day: 14), amount: 78.2)
    ]),
    .init(name: "체지방량 (kg)", measurements: [
      (day: Date.of(year: 2022, month: 5, day: 2), amount: 15.2),
      (day: Date.of(year: 2022, month: 5, day: 9), amount: 15.0),
      (day: Date.of(year: 2022, month: 5, day: 16), amount: 14.8),
      (day: Date.of(year: 2022, month: 5, day: 23), amount: 14.7),
      (day: Date.of(year: 2022, month: 5, day: 30), amount: 14.2),
      (day: Date.of(year: 2022, month: 6, day: 7), amount: 14.0),
      (day: Date.of(year: 2022, month: 6, day: 14), amount: 13.2)
    ]),
    .init(name: "골격근량 (kg)", measurements: [
      (day: Date.of(year: 2022, month: 5, day: 2), amount: 17.2),
      (day: Date.of(year: 2022, month: 5, day: 9), amount: 17.2),
      (day: Date.of(year: 2022, month: 5, day: 16), amount: 17.3),
      (day: Date.of(year: 2022, month: 5, day: 23), amount: 17.4),
      (day: Date.of(year: 2022, month: 5, day: 30), amount: 17.6),
      (day: Date.of(year: 2022, month: 6, day: 7), amount: 18.0),
      (day: Date.of(year: 2022, month: 6, day: 14), amount: 18.2)
    ])
  ]
}
